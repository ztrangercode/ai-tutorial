...
import { predictDigit, loadModel, PredictionResult } from './api/inference';
...
const App: React.FC = () => {
  ...
  React.useEffect(() => {
    loadModel().catch(err => {
      ...
      Alert.alert("Error", "Could not load local AI model. Please check Exercise 7.");
    });
  }, []);
      ...
      <SafeAreaView style={styles.container}>
        ...
        <ScrollView contentContainerStyle={styles.scrollContent}>
          <View style={styles.header}>
            <Text style={styles.title}>Digit Recognizer (Local AI)</Text>
            <Text style={styles.subtitle}>Local Offline AI Mode</Text>
          </View>
